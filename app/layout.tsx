...
export const metadata: Metadata = {
  title: "SasSify | The Future of Webapp Today",
  description:
    "Discover SaaSApp: The all-in-one solution to streamline your workflow, boost productivity, and drive results. Built for modern teams.",
  generator: "sassify.tech",
}
